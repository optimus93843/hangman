...
def menu_pygame():
    ...
    screen.blit(rules_label, (150, 250))
    screen.blit(help_label, (150, 500))
    screen.blit(game_label, (150, 750))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_TAB:
                    message_0 = font.render(help_0, True, (100, 100, 100))
                    screen.blit(message_0, (50, 550))
                    message_1 = font.render(help_1, True, (100, 100, 100))
                    screen.blit(message_1, (50, 600))
                    message_2 = font.render(help_2, True, (100, 100, 100))
                    screen.blit(message_2, (50, 650))
                    message_3 = font.render(help_3, True, (100, 100, 100))
                    screen.blit(message_3, (50, 700))
                elif event.key == pygame.K_RETURN:
                    message_1 = font.render(rules_1, True, (100,100,100))
                    message_2 = font.render(rules_2, True, (100,100,100))
                    message_3 = font.render(rules_3, True, (100,100,100))
                    message_4 = font.render(rules_4, True, (100,100,100))
